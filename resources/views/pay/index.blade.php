...
@else
        ...
        <div class="row justify-content-center">
            <div class="col-md-8" style="display: flex;align-items: center;justify-content: center">
                <div class="card" >
                    ...
                    <div>
                        <a href="{{route('credit.show',['student_id'=>$student->id,'amount'=>$amount,'month'=>$month])}}" class="fancy-button" style="width:100%">XPay</a>
                    </div>
                    <div class="card-body">
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AYd3vRCPCkLbVdZn83jrCH3cvdZi7dOa8YnhKuUHCmi4nbcv82DoeDdUWngu2NvgY_sC3t_2c1J_8bgF&components=buttons&currency={{$student->currency}}"></script>
        <script>
            paypal.Buttons({
